            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('img/Logos/Fosc_sense_bg.png') }}" alt="" class="block w-auto fill-current text-gray-200" style="height: 5rem;">                    
                    </a>
                </div>
                ...
                <div class="flex-grow flex items-center justify-center relative uniform-margin">
                    ...
                    <div id="search-results" class="absolute top-full mt-2 w-full max-w-2xl bg-gray-900 rounded-lg shadow-lg z-50 hidden">
                        <ul id="results-list" class="divide-y divide-gray-700"></ul>
                    </div>
                </div>
                                    ...
                                    .then(data => {
                                        ...
                                        if (data.esdeveniments.length > 0 || data.empreses.length > 0) {
                                            data.esdeveniments.forEach(esdeveniment => {
                                                ...
                                                li.classList.add('p-2', 'hover:bg-gray-800', 'flex', 'items-center');
                                                li.innerHTML = `
                                                    <img src="data:image/png;base64,${esdeveniment.foto_portada}" alt="${esdeveniment.nom}" class="h-10 w-10 rounded-full mr-3">
                                                    <div>
                                                        <a href="/esdeveniments/${esdeveniment.id_esdeveniment}" class="block text-gray-200">
                                                            ${esdeveniment.nom}
                                            ...
                                            data.empreses.forEach(empresa => {
                                                ...
                                                li.innerHTML = `
                                                    ...
                                                    <div>
                                                        <a href="/inici/${empresa.id_empresa}" class="block text-gray-200">
                                                            ${empresa.nom_empresa}
                                                            <span class="flex items-center text-sm text-pink-500">
                                                                <svg class="h-2 w-2 mr-1" fill="currentColor" viewBox="0 0 8 8">
                                                                    <circle cx="4" cy="4" r="3" />
                                                                </svg>
                                                                Empresa
