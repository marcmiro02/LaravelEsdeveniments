<x-app-layout>
    ...
    <div class="min-h-screen bg-black flex items-center justify-center">
        ...
        <div class="bg-gray-900 p-8 rounded-lg shadow-lg max-w-7xl w-full sm:px-6 lg:px-8 text-gray-100">
            ...
            <!-- Title -->
            <h3 class="text-3xl font-bold text-rose-600 mb-6 text-center">Crear Tipus d'Esdeveniment</h3>


            <form action="{{ route('tipus_esdeveniments.store') }}" method="POST" class="space-y-6">
                @csrf

                <div class="mb-4">
                    <label for="nom_tipus" class="block text-lg font-medium text-gray-100">Nom del Tipus
                        d'Esdeveniment</label>
                    <input type="text" id="nom_tipus" name="nom_tipus"
