<x-app-layout>
    ...
    <div class="min-h-screen bg-black flex items-center justify-center">
        ...
        <div class="bg-gray-900 p-8 rounded-lg shadow-lg max-w-7xl w-full sm:px-6 lg:px-8 text-gray-100">
            ...
            <!-- Title -->
            <h3 class="text-3xl font-bold text-rose-600 mb-6 text-center">Registre</h3>
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <!-- Surname -->
                <div>
                    <x-input-label for="surname" :value="__('Cognoms')" />
                ...
                <!-- Username -->
                <div>
                    <x-input-label for="nom_usuari" :value="__('Nom d\'Usuari')" />
                ...
                <!-- Address -->
                <div>
                    <x-input-label for="adreca" :value="__('Direcció')" />
                ...
                <!-- Date of Birth -->
                <div>
                    <x-input-label for="data_naixement" :value="__('Data de naixement')" />
