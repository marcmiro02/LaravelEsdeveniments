<x-app-layout>
    ...
    <div class="min-h-screen bg-black flex items-center justify-center">
        ...
        <div class="bg-gray-900 p-8 rounded-lg shadow-lg max-w-md w-full text-gray-100">
            ...
            <!-- Title -->
            <h3 class="text-3xl font-bold text-rose-600 mb-6 text-center">Detalls del Rol</h3>

            <!-- Rol Details -->
            <div class="mb-6">
                <strong class="block text-lg font-medium text-gray-100 mb-2">Nom del Rol:</strong>
                <p class="text-xl font-semibold text-white">{{ $rol->nom_rol }}</p>
            </div>

            <!-- Actions -->
            <div class="flex justify-center space-x-4">
                <!-- Edit Button -->
                <a href="{{ route('rols_usuaris.edit', $rol->id_rol) }}" 
                ...
                <!-- Delete Button -->
                <form action="{{ route('rols_usuaris.destroy', $rol->id_rol) }}" method="POST" class="inline-block">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
