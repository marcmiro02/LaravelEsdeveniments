<x-app-layout>
    ...
    <div class="min-h-screen bg-black flex items-center justify-center">
        ...
        <div class="bg-gray-900 p-8 rounded-lg shadow-lg max-w-7xl w-full sm:px-6 lg:px-8 text-gray-100">
            ...
            <form action="{{ route('rols_usuaris.update', $rol->id_rol) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                
                <div class="mb-4">
                    <label for="nom_rol" class="block text-lg font-medium text-gray-100">Nom del Rol</label>
                    <input type="text" id="nom_rol" name="nom_rol" value="{{ $rol->nom_rol }}" 
