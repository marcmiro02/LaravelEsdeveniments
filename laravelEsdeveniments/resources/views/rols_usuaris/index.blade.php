    ...
    <div class="min-h-screen bg-black flex items-center justify-center">
        ...
        <div class="bg-gray-900 p-8 rounded-lg shadow-lg max-w-7xl w-full sm:px-6 lg:px-8 text-gray-100">
            ...
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-3xl font-bold text-rose-600">{{ __("Llistat de Rols") }}</h3>
            ...
            <!-- Table -->
            @if ($rols_usuaris->isEmpty())
                <p class="text-center text-lg text-gray-400">No s'han trobat rols_usuaris.</p>
            @else
                <table class="w-full table-auto text-left">
                    <thead>
                        <tr class="border-b border-gray-700">
                            <th class="px-4 py-2 text-lg font-medium">Nom Rol</th>
